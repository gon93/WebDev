  ...
  <main>
    ...
    <div class="container-fluid">
      <div class="dp-container">
        <div class="row">
          <!-- First 3 grid - Prodcut Image and Author's Section -->
                ...
                <div class="formats">
                  <a href="#" class="link-expander">
                    ...
                    <span class="tmmShowPrompt"
                      >Sell all 18 formats and editions</span
                    >
                  </a>
                  <ul>
                    <!-- Kindle -->
                        ...
                        <span class="a-button-toggle">
                          <span class="a-button-inner">
                            <a href="#" class="a-button-text">
                              <span>Kindle</span>
                              <br />
                              <span class="a-color-seoncarday">-</span>
                            </a>
                          </span>
                        </span>
              ...
              <div class="buyBox">
                  ...
                  <div class="a-spacing-top-small">
                    <div class="a-section a-spacing-none">
                      <div class="a-section a-spacing-none a-spacing-top-mini">
                        This item ships to
                        <b
                          >California Get it by Monday, Sept. 23 - Monday, Sept.
                          30</b
                        >
                ...
                <span class="a-declarative">
                  <a href="#" class="a-link-normal">
                    <div class="a-row a-spacing-mini">
                      <i class="fal famap-market-alt"></i>
                ...
                <div class="a-section">
                  <div class="clearfix">
                    <div class="float-left">
                      <form>
                        <input type="radio" id="text2" name="radio-group" />
                        <label for="test1">Buy Now</label>
                      </form>
                    </div>
                    <div class="float-right">
                      <span class="a-colo-base offer-price a-text-normal"
                        >${{product.price}}</span
                      >
                    </div>
                  </div>
