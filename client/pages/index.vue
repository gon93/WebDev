<template>
  <main class="listingPage">
    <div class="container-fluid">
      <div class="row">
        <!-- Side Bar -->
        <div class="col-xl-2 col-lg-3 col-sm-4"></div>
                  ...
                  <div>
                    <div class="row">
                      ...
                      <div class="col-sm-9">
                        ...
                        <!-- Author's name -->
                        <div class="a-row a-spacing-small">
                          <span class="a-szie-small a-color-secondary">by</span>
                          <span class="a-size-small a-color-secondary">
                            <a class="a-link-normal a-text-normal" href="#">{{product.ownerID.name}} </a>
                          </span>
                        </div>
                          ...
                          <div class="col-sm-7">
                            ...
                            <div class="a-row a-spacing-none">
                              <a href="#" class="a-link-normal a-text-normal">
                                ...
                                <span class="a-color-base sx-zero-spacing"></span>
